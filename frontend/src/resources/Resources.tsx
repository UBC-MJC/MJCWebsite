export const Resources = () => {
    return (
        <div className={"my-4"}>
            ...
            <p>
                {"Beginner's Luck "}
                <a className="link" href="http://beginners.biz/">
                    Japanese
                </a>{" "}
                <a className="link" href="https://www.bilibili.com/read/readlist/rl45758">
                    Chinese
                </a>
            </p>
            <p>
                ...
                <a className="link" href="https://www.bilibili.com/read/readlist/rl509592">
                    Chinese
                </a>
            </p>
            <p>
                ...
                <a className="link" href="https://www.bilibili.com/read/readlist/rl380536">
                    Chinese
                </a>
            </p>
            <p>
                ...
                <a className="link" href="https://www.bilibili.com/read/readlist/rl493079">
                    Chinese
                </a>
            </p>
