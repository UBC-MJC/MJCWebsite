...
export const PlacementHistoryGraph = memo(({ data }: PlacementHistoryGraphProps) => {
    ...
    const chartData = graphData.map((entry, index) => ({
        game: index - graphData.length,
        ...
        <Stack spacing={3}>
            <Paper sx={{ p: 2 }}>
                        ...
                        <LineChart
                            ...
                            slots={{
                                mark: (props) => {
                                    ...
                                    const color = placement ? PLACEMENT_COLORS[placement] : "#000";
                                    return (
                                        <circle
                                            cx={x}
                                            cy={y}
                ...
                <Typography variant="caption" color="textSecondary" mt={1} display={"block"}>
                    Colored dots represent each game placement (Gold = 1st, Silver = 2nd, Bronze =
                    3rd, Gray = 4th)
                </Typography>
            </Paper>
            ...
            <Grid container spacing={2}>
                <Grid size={6}>
                    <Paper sx={{ p: 2, textAlign: "center" }}>
                        <Typography variant="h4" color={PLACEMENT_COLORS[1]} fontWeight="bold">
                            {stats[1]}
                        </Typography>
                ...
                <Grid size={6}>
                    <Paper sx={{ p: 2, textAlign: "center" }}>
                        <Typography variant="h4" color={PLACEMENT_COLORS[2]} fontWeight="bold">
                            {stats[2]}
                        </Typography>
                        <Typography variant="body2" color="textSecondary">
                            2nd Place
                ...
                <Grid size={6}>
                    <Paper sx={{ p: 2, textAlign: "center" }}>
                        <Typography variant="h4" color={PLACEMENT_COLORS[3]} fontWeight="bold">
                            {stats[3]}
                        </Typography>
                        <Typography variant="body2" color="textSecondary">
                            3rd Place
                ...
                <Grid size={6}>
                    <Paper sx={{ p: 2, textAlign: "center" }}>
                        <Typography variant="h4" color={PLACEMENT_COLORS[4]} fontWeight="bold">
                            {stats[4]}
                        </Typography>
                        <Typography variant="body2" color="textSecondary">
                            4th Place
